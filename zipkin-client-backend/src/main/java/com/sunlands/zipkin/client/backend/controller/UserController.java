package com.sunlands.zipkin.client.backend.controller;
...
//        return "hello"+id;
        ...
        String result= this.restTemplate.getForObject("http://localhost:9099/api/category/front/list", String.class);
        return result+" world";
    }
